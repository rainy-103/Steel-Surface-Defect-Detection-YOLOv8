...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-t.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/train/yolov9-af', help='save to project/name')
